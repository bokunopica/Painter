...
import SegGPT.SegGPT_train.util.lr_decay as lrd
import SegGPT.SegGPT_train.util.misc as misc
from SegGPT.SegGPT_train.util.misc import get_parameter_groups
from SegGPT.SegGPT_train.util.misc import NativeScalerWithGradNormCount as NativeScaler
from SegGPT.SegGPT_train.util.pos_embed import interpolate_pos_embed

from SegGPT.SegGPT_train import models_seggpt

from SegGPT.SegGPT_train.engine_train import train_one_epoch, evaluate_pt, prepare_model

from SegGPT.SegGPT_train.data.pairdataset import PairDataset
import SegGPT.SegGPT_train.data.pair_transforms as pair_transforms
from SegGPT.SegGPT_train.util.masking_generator import MaskingGenerator
from SegGPT.SegGPT_train.data.sampler import DistributedSamplerWrapper
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--ckpt_path', type=str, metavar='MODEL',
...
def main(args, ds_init):
    ...
    # define the model
    # model = models_seggpt.__dict__[args.model]()
    model = prepare_model(
        chkpt_dir=args.ckpt_path,
